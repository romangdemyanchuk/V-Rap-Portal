...
import { LOGIN, REGISTER, LOADING, ADD_CASE, DELETE_CASE, USER_INFO, PART_INFO, ALL_CASES,
  ALL_RESEARCHERS, REGISTER_BY_ADMIN,PENDING_CASES_COUNT, FILTERED_CASES, DISABLE_BUTTONS
...
export const filteredCasesData = (payload) => ({type: FILTERED_CASES, payload})
